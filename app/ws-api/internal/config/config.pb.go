...
var file_app_ws_api_internal_config_config_proto_goTypes = []interface{}{
	...
	(*Data_Redis)(nil),          // 4: wsapi.Data.Redis
	(*Registry_ETCD)(nil),       // 5: wsapi.Registry.ETCD
...
var file_app_ws_api_internal_config_config_proto_depIdxs = []int32{
	...
	6, // 3: wsapi.Server.http:type_name -> server.Config
	6, // 4: wsapi.Server.grpc:type_name -> server.Config
	4, // 5: wsapi.Data.redis:type_name -> wsapi.Data.Redis
	5, // 6: wsapi.Registry.etcd:type_name -> wsapi.Registry.ETCD
	7, // 7: wsapi.Registry.ETCD.dialTimeout:type_name -> google.protobuf.Duration
